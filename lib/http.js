module.exports = new function () {
	...
	function handlePush(req, res, data, apnsProvider) {
		...
		note.expiry = data.notification.expiry || 0;
		note.badge = data.notification.badge;
		note.sound = data.notification.sound;
		note.alert = data.notification.alert;
		note.payload = data.notification.payload || {};
		note.topic = data.notification.topic;
